...
">
                ...
                <div class="col-lg-11" style="padding:0px"><input name="username" type="text"
...
">
                ...
                <div class="col-lg-11" style="padding:0px"><input name ="userPassword" type="password"
                                                                  style="font-size: medium; width: 100%;border: 0px;"
                                                                  class="no-outline"
    ...
    height: 35px;font-size: 15px;">SignIn
                        </button>
                    </div>
                    <div class="col-lg-6"><a href="register.html">
                        <button type="button" class="btn btn-primary" style="width: 100%;
    height: 35px;font-size: 15px;">Register
                        </button>
                    </a></div>
